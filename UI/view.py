...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        row1 = ft.Row([ft.Container(self._txtAnno, width=250),
                       ft.Container(self._btnCalcola, width=250)],
                      alignment=ft.MainAxisAlignment.CENTER)
        self._ddStato = ft.Dropdown(label="Stati", disabled=True)
        self._btnRaggiungibili = ft.ElevatedButton("Calcola raggiungibili", on_click=self._controller.handleRaggiungibili, disabled=True)
        row2 = ft.Row([ft.Container(self._ddStato, width=250),
